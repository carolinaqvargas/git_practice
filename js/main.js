...
function verifierImposition() {
  ...
  if (genreSaisie == "H" && ageSaisie > 20) {
    message.innerHTML =
      '<div class="alert alert-danger" role="alert"> Vous etes imposable !</div>';
  } else if (genreSaisie === "F" && ageSaisie >= 18 && ageSaisie <= 35) {
    message.innerHTML =
      '<div class="alert alert-danger" role="alert"> Vous etes imposable !</div>';
  } else {
    message.innerHTML =
      '<div class="alert alert-success" role="alert"> Vous etes non imposable !</div>';
  }
}
...
let bouton8 = document.getElementById("bouton8");
...
bouton8.addEventListener('click', verifierProposition, false);
